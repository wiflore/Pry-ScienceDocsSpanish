"""
Fine-tuning XLM-RoBERTa-large para clasificación retórica de 8 clases (Task 1).
...
Diferencias respecto a SciBETO:
  - MODEL_ID = "xlm-roberta-large" (multilingüe general, 560M params)
  - Mismo pipeline, hiperparámetros y tokenización Head+Tail
"""
...
OUTPUT_DIR = Path("models/xlmroberta-task1-8clases")
RESULTS_PATH = Path("reports/entrega3/results_task1_xlmroberta.json")
...
def main():
    ...
    results = {
        "modelo": "XLM-RoBERTa-large (fine-tuned, 8 clases, Head+Tail, weighted loss)",
